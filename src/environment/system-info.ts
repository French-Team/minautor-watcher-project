 ...
 */
function getNpmVersion(): Promise<string | null> {
 ...
 */
function readGPUVramFromRegistry(): number | null {
...
export function formatSystemInfo(info: SystemInfo): string {
  ...
  const connected = info.networkInterfaces.filter((n) =>
    /connect/i.test(n.state)
  );
