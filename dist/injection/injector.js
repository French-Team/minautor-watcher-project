 ...
 */
function buildManagedSection(templateContent, version) {
 ...
 */
function mergeWithExistingContent(existing, templateContent, version) {
    ...
    for (const agentStatus of status.agents) {
        ...
        for (const template of templates) {
            ...
            try {
                ...
                const merged = mergeWithExistingContent(existing, template.content, template.version);
 ...
 */
export function formatInjectionResults(results) {
    const lines = ["Injection results:"];
